...
namespace AddressBookManagement
{
    class Program
    {
        public static void FillingDetails(AddMultipleDetails contact)
        {
        ...
        public static void CreatingContacts()
        {
            ...
            while (num == 1)
            {
                AddMultipleDetails contact = new AddMultipleDetails();
        ...
        public static void DisplayContacts()
        {
            ...
            foreach (AddMultipleDetails contact in contactList)
            {
        ...
        public static List<AddMultipleDetails> contactList = new List<AddMultipleDetails>();
